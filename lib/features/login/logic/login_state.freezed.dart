...
mixin _$LoginState<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(ApiErrorModel error) loginError,
  }) =>
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(ApiErrorModel error)? loginError,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
abstract class LoginError<T> implements LoginState<T> {
  const factory LoginError(final ApiErrorModel error) = _$LoginErrorImpl<T>;
